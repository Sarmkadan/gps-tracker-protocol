...
public class ReplayOptions
{
    ...
    /// <summary>
    /// Returns a string representation of the <see cref="ReplayOptions"/> object.
    /// </summary>
    /// <returns>A string representation of the <see cref="ReplayOptions"/> object.</returns>
...
/// <summary>
/// Represents a single waypoint emitted during a route replay, paired with its replay-adjusted timestamp.
/// </summary>
public class ReplayFrame
{
    /// <summary>
    /// Gets or sets the sequential position of this frame within the replay (zero-based).
    /// </summary>
    public int Index { get; set; }

    /// <summary>
    /// Gets or sets the location data for this waypoint.
    /// </summary>
    ...
    /// Takes <see cref="ReplayOptions.SpeedMultiplier"/> and <see cref="ReplayOptions.RebaseToUtc"/> into account.
    /// </summary>
    public DateTime ReplayTimestamp { get; set; }

    /// <summary>
    /// Gets or sets the elapsed replay time since the first frame.
    /// </summary>
    public TimeSpan ElapsedReplay { get; set; }

    /// <summary>
    /// Gets or sets the cumulative distance from the first frame to this frame in kilometers.
    /// </summary>
    public double CumulativeDistanceKm { get; set; }
}

/// <summary>
/// Represents the complete output of a route replay operation.
/// </summary>
public class RouteReplayResult
{
    /// <summary>
    /// Gets or sets the identifier of the journey that was replayed.
    /// </summary>
    public string JourneyId { get; set; } = string.Empty;

    /// <summary>
    /// Gets or sets the identifier of the device associated with the replayed journey.
    /// </summary>
    public string DeviceId { get; set; } = string.Empty;

    /// <summary>
    /// Gets or sets the options that were used to produce this replay.
    /// </summary>
    public ReplayOptions Options { get; set; } = new();

    /// <summary>
    /// Gets or sets the ordered sequence of replay frames.
    /// </summary>
    public IReadOnlyList<ReplayFrame> Frames { get; set; } = [];

    /// <summary>
    /// Gets or sets the total distance covered by the replayed segment in kilometers.
    /// </summary>
    public double TotalDistanceKm { get; set; }

    /// <summary>
    /// Gets or sets the real-world duration of the replayed segment.
    /// </summary>
    public TimeSpan OriginalDuration { get; set; }

    /// <summary>
    /// Gets or sets the duration at the configured speed multiplier.
    /// </summary>
